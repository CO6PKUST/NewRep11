...
--
-- Name: dataobj; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.dataobj (
    dataobj_id integer NOT NULL,
    dataobjname character varying(256) NOT NULL,
    ext character varying(8) NOT NULL,
    reference text NOT NULL
);


ALTER TABLE public.dataobj OWNER TO postgres;

--
-- Name: dataobj_dataobj_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE public.dataobj ALTER COLUMN dataobj_id ADD GENERATED ALWAYS AS IDENTITY (
...
CREATE TABLE public.education (
    ...
    universitytitle character varying(128)
);
...
--
-- Name: has_dataobj; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.has_dataobj (
...
ALTER TABLE public.has_dataobj OWNER TO postgres;

--
-- Name: hobbytable; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.hobbytable (
    hobby_id integer NOT NULL,
    hobbyname character varying(128) NOT NULL
);


ALTER TABLE public.hobbytable OWNER TO postgres;

--
-- Name: hobbytable_hobby_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE public.hobbytable ALTER COLUMN hobby_id ADD GENERATED ALWAYS AS IDENTITY (
...
--
-- Name: languagetable; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.languagetable (
    language_id integer NOT NULL,
    languagename character varying(32) NOT NULL
);


ALTER TABLE public.languagetable OWNER TO postgres;

--
-- Name: languagetable_language_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE public.languagetable ALTER COLUMN language_id ADD GENERATED ALWAYS AS IDENTITY (
...
CREATE TABLE public.messages (
    fromperson_id integer NOT NULL,
    toperson_id integer NOT NULL,
    messagetime timestamp without time zone NOT NULL,
...
CREATE TABLE public.person_profile (
    ...
    personpic integer,
    personcover integer,
    numberbankcard character varying(32),
    birthday date,
...
--
-- Name: personrole; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.personrole ALTER COLUMN role_id ADD GENERATED ALWAYS AS IDENTITY (
...
CREATE TABLE public.post (
    ...
    person_id integer NOT NULL,
    description text,
    timeplacement timestamp without time zone NOT NULL
);
...
--
-- Data for Name: dataobj; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.dataobj (dataobj_id, dataobjname, ext, reference) FROM stdin;
\.
...
COPY public.education (person_id, university, universitytitle) FROM stdin;
\.
...
--
-- Data for Name: has_dataobj; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.has_dataobj (entity, dataobj_id, entity_id) FROM stdin;
\.


--
-- Data for Name: hobbytable; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.hobbytable (hobby_id, hobbyname) FROM stdin;
\.
...
COPY public.job (person_id, job, jobtitle) FROM stdin;
\.


--
-- Data for Name: languagetable; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.languagetable (language_id, languagename) FROM stdin;
\.
...
COPY public.messages (fromperson_id, toperson_id, messagetime, description, messages_id) FROM stdin;
\.
...
COPY public.person (person_id, firstname, secondname, email, hashpassword, nickname, enabled) FROM stdin;
...
COPY public.person_profile (person_id, sex, aboutme, dateregistration, personpic, personcover, numberbankcard, birthday, lastonline) FROM stdin;
\.
...
COPY public.personrole (role_id, rolename) FROM stdin;
2	ROLE_ADMIN
1	ROLE_USER
\.
...
COPY public.post (post_id, person_id, description, timeplacement) FROM stdin;
\.
...
--
-- Name: dataobj dataobj_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.dataobj
    ADD CONSTRAINT dataobj_pkey PRIMARY KEY (dataobj_id);
...
--
-- Name: has_dataobj has_dataobj_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.has_dataobj
    ADD CONSTRAINT has_dataobj_pkey PRIMARY KEY (entity, dataobj_id, entity_id);


--
-- Name: hobbytable hobbytable_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.hobbytable
...
--
-- Name: languagetable languagetable_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.languagetable
...
--
-- Name: personrole personrole_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: has_dataobj data_obj_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.has_dataobj
    ADD CONSTRAINT data_obj_id_fk FOREIGN KEY (dataobj_id) REFERENCES public.dataobj(dataobj_id) NOT VALID;


--
-- Name: has_dataobj entitymessage_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: has_dataobj entitypost_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: has_dataobj entityremark_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
ALTER TABLE ONLY public.messages
    ADD CONSTRAINT fromperson_id_fk FOREIGN KEY (fromperson_id) REFERENCES public.person(person_id) NOT VALID;
...
ALTER TABLE ONLY public.person_has_hobby
    ADD CONSTRAINT hobby_id_fk FOREIGN KEY (hobby_id) REFERENCES public.hobbytable(hobby_id) NOT VALID;
...
ALTER TABLE ONLY public.person_speak_language
    ADD CONSTRAINT language_id_fk FOREIGN KEY (language_id) REFERENCES public.languagetable(language_id) NOT VALID;
...
ALTER TABLE ONLY public.person_profile
    ADD CONSTRAINT personcover_fk FOREIGN KEY (personcover) REFERENCES public.dataobj(dataobj_id) NOT VALID;
...
ALTER TABLE ONLY public.person_profile
    ADD CONSTRAINT personpic_fk FOREIGN KEY (personpic) REFERENCES public.dataobj(dataobj_id) NOT VALID;
...
ALTER TABLE ONLY public.person_has_role
    ADD CONSTRAINT role_id_fk FOREIGN KEY (role_id) REFERENCES public.personrole(role_id) NOT VALID;
...
ALTER TABLE ONLY public.messages
    ADD CONSTRAINT toperson_id_fk FOREIGN KEY (toperson_id) REFERENCES public.person(person_id) NOT VALID;
